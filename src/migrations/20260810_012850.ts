...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_services_category" AS ENUM('build', 'get-found', 'convert', 'automate');
  ...
  CREATE TYPE "public"."enum_leads_services" AS ENUM('web-design', 'web-development', 'ecommerce', 'seo', 'local-seo', 'google-ads', 'meta-ads', 'conversion-optimization', 'ai-automation', 'crm-systems', 'branding', 'website-maintenance', 'full-system');
  CREATE TYPE "public"."enum_leads_status" AS ENUM('new', 'contacted', 'call-booked', 'proposal-sent', 'won', 'lost', 'disqualified');
  CREATE TYPE "public"."enum_leads_budget" AS ENUM('under-5k', '5k-15k', '15k-35k', '35k-75k', '75k-plus', 'unsure');
  CREATE TYPE "public"."enum_leads_timeline" AS ENUM('urgent', '1-3-months', '3-6-months', 'exploring');
  CREATE TYPE "public"."enum_payload_jobs_log_task_slug" AS ENUM('inline', 'schedulePublish');
  CREATE TYPE "public"."enum_payload_jobs_log_state" AS ENUM('failed', 'succeeded');
  CREATE TYPE "public"."enum_payload_jobs_task_slug" AS ENUM('inline', 'schedulePublish');
  CREATE TYPE "public"."enum_site_settings_social_links_platform" AS ENUM('LinkedIn', 'Instagram', 'Facebook', 'X', 'YouTube', 'GitHub', 'Google Business Profile', 'Clutch', 'Other');
  ...
  CREATE TABLE "services_deep_dive" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar NOT NULL,
  	"paragraphs" varchar NOT NULL
  );
  ...
  CREATE TABLE "services" (
  	...
  	"icon" varchar DEFAULT 'Sparkles' NOT NULL,
  	"order" numeric DEFAULT 100 NOT NULL,
  	"category" "enum_services_category" DEFAULT 'build' NOT NULL,
  	"title" varchar NOT NULL,
  	...
  	"problems_heading" varchar NOT NULL,
  	"included_heading" varchar NOT NULL,
  	"included_intro" varchar NOT NULL,
  	"approach_heading" varchar NOT NULL,
  	"outcomes_heading" varchar NOT NULL,
  	"outcomes_intro" varchar NOT NULL,
  ...
  CREATE TABLE "industries_system" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  ...
  CREATE TABLE "industries_deep_dive" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"heading" varchar NOT NULL,
  ...
  CREATE TABLE "industries" (
  	...
  	"challenges_intro" varchar NOT NULL,
  	"buyer_behaviour_heading" varchar NOT NULL,
  	"buyer_behaviour" varchar NOT NULL,
  	"system_heading" varchar NOT NULL,
  	"system_intro" varchar NOT NULL,
  	"cta_heading" varchar NOT NULL,
  	"cta_body" varchar NOT NULL,
  	"seo_meta_title" varchar NOT NULL,
  	"seo_meta_description" varchar NOT NULL,
  ...
  CREATE TABLE "case_studies_deliverables" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "case_studies" (
  	...
  	"strategy" varchar,
  	"execution" varchar,
  	"before_after_before_image_id" integer,
  	"before_after_after_image_id" integer,
  	"before_after_before_notes" varchar,
  	"before_after_after_notes" varchar,
  ...
  CREATE TABLE "_case_studies_v_version_deliverables" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_case_studies_v" (
  	...
  	"version_strategy" varchar,
  	"version_execution" varchar,
  	"version_before_after_before_image_id" integer,
  	"version_before_after_after_image_id" integer,
  	"version_before_after_before_notes" varchar,
  	"version_before_after_after_notes" varchar,
  ...
  CREATE TABLE "site_settings_trust_stats" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"value" varchar NOT NULL,
  	"label" varchar NOT NULL,
  	"icon" varchar DEFAULT 'Rocket'
  );
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"legal_name" varchar DEFAULT 'Digital Kingz Development' NOT NULL,
  	"brand_name" varchar DEFAULT 'Digital Kingz' NOT NULL,
  	"tagline" varchar DEFAULT 'We Build Digital Systems That Grow Businesses.' NOT NULL,
  	"description" varchar NOT NULL,
  	"logo_id" integer,
  	"founding_year" numeric,
  	"email" varchar DEFAULT 'solutions@digitalkingz.com' NOT NULL,
  	"phone" varchar,
  	"booking_url" varchar,
  ...
  ALTER TABLE "services_deep_dive" ADD CONSTRAINT "services_deep_dive_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "industries_system" ADD CONSTRAINT "industries_system_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."industries"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "industries_deep_dive" ADD CONSTRAINT "industries_deep_dive_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."industries"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "industries_faqs" ADD CONSTRAINT "industries_faqs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."industries"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "case_studies_deliverables" ADD CONSTRAINT "case_studies_deliverables_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."case_studies"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_before_after_before_image_id_media_id_fk" FOREIGN KEY ("before_after_before_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_before_after_after_image_id_media_id_fk" FOREIGN KEY ("before_after_after_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_case_studies_v_version_deliverables" ADD CONSTRAINT "_case_studies_v_version_deliverables_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_case_studies_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_before_after_before_image_id_media_id_fk" FOREIGN KEY ("version_before_after_before_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_before_after_after_image_id_media_id_fk" FOREIGN KEY ("version_before_after_after_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings_trust_stats" ADD CONSTRAINT "site_settings_trust_stats_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "site_settings_clients" ADD CONSTRAINT "site_settings_clients_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "services_deep_dive_order_idx" ON "services_deep_dive" USING btree ("_order");
  CREATE INDEX "services_deep_dive_parent_id_idx" ON "services_deep_dive" USING btree ("_parent_id");
  ...
  CREATE INDEX "industries_system_order_idx" ON "industries_system" USING btree ("_order");
  CREATE INDEX "industries_system_parent_id_idx" ON "industries_system" USING btree ("_parent_id");
  CREATE INDEX "industries_deep_dive_order_idx" ON "industries_deep_dive" USING btree ("_order");
  CREATE INDEX "industries_deep_dive_parent_id_idx" ON "industries_deep_dive" USING btree ("_parent_id");
  CREATE INDEX "industries_faqs_order_idx" ON "industries_faqs" USING btree ("_order");
  CREATE INDEX "industries_faqs_parent_id_idx" ON "industries_faqs" USING btree ("_parent_id");
  ...
  CREATE INDEX "case_studies_deliverables_order_idx" ON "case_studies_deliverables" USING btree ("_order");
  CREATE INDEX "case_studies_deliverables_parent_id_idx" ON "case_studies_deliverables" USING btree ("_parent_id");
  ...
  CREATE INDEX "case_studies_before_after_before_after_before_image_idx" ON "case_studies" USING btree ("before_after_before_image_id");
  CREATE INDEX "case_studies_before_after_before_after_after_image_idx" ON "case_studies" USING btree ("before_after_after_image_id");
  ...
  CREATE INDEX "_case_studies_v_version_deliverables_order_idx" ON "_case_studies_v_version_deliverables" USING btree ("_order");
  CREATE INDEX "_case_studies_v_version_deliverables_parent_id_idx" ON "_case_studies_v_version_deliverables" USING btree ("_parent_id");
  ...
  CREATE INDEX "_case_studies_v_version_before_after_version_before_afte_idx" ON "_case_studies_v" USING btree ("version_before_after_before_image_id");
  CREATE INDEX "_case_studies_v_version_before_after_version_before_af_1_idx" ON "_case_studies_v" USING btree ("version_before_after_after_image_id");
  ...
  CREATE INDEX "site_settings_trust_stats_order_idx" ON "site_settings_trust_stats" USING btree ("_order");
  CREATE INDEX "site_settings_trust_stats_parent_id_idx" ON "site_settings_trust_stats" USING btree ("_parent_id");
  ...
  CREATE INDEX "site_settings_clients_logo_idx" ON "site_settings_clients" USING btree ("logo_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "services_deep_dive" CASCADE;
  DROP TABLE "services_faqs" CASCADE;
  DROP TABLE "services" CASCADE;
  DROP TABLE "services_rels" CASCADE;
  DROP TABLE "industries_challenges" CASCADE;
  DROP TABLE "industries_system" CASCADE;
  DROP TABLE "industries_deep_dive" CASCADE;
  DROP TABLE "industries_faqs" CASCADE;
  ...
  DROP TABLE "case_studies_deliverables" CASCADE;
  ...
  DROP TABLE "_case_studies_v_version_deliverables" CASCADE;
  ...
  DROP TABLE "site_settings_trust_stats" CASCADE;
