...
export default async function PeoplePage() {
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="Digital Kingz People"
        title="Discover the people shaping the world"
        description={DESCRIPTION}
        breadcrumbs={crumbs}
      />
      ...
      <Section>
        <div className="flex flex-col gap-10">
          ...
          <Reveal>
            <SectionHeading eyebrow="Browse" title="Find people by category" />
          </Reveal>
          <Reveal delay={60}>
